...
df =rbind(df, c("Date of check:",  yaml_data$codechecker$check_time))
df =rbind(df, c("Date of check:",  yaml_data$codechecker$check_time))
df =rbind(df, c("Repository:",  yaml_data$codechecker$repository))
...
print(xtable(df, align=c('l', 'l', 'p{10cm}'), caption='CODECHECK summary'), include.rownames=FALSE, include.colnames=TRUE)
```
